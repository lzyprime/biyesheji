...
| deleteComment_03 | 其他用户或未登录状态 | 尝试点击按钮删除评论                         | 删除评论按钮不可点击           |
...
本博客系统面向移动客户端，提供的功能有浏览文章、收藏关注、评论和个性化设置等功能。方便用户关注自己感兴趣内容，根据自己的习惯定制应用风格。
在具体的系统设计与实现中，前端采用Flutter框架，以声明式UI构建所有页面，能同时适配多个平台。运用MVVM架构理念，将视图层和数据绑定，使得数据更新时精确更新局部UI组件，提高效率。后端使用Kotlin作为开发语言，利用语法优势，代码精简，开发高效。后端Ktor框架为先进的异步Web框架，基础框架内容精简，附加功能插件化，可根据需求添加，整体轻量易用。数据库数据库设计中文章信息、用户信息、评论信息作为基础数据，同时根据关系构建出整体数据库。
由于时间原因，系统的部分内容仍有不足和改进空间。前端视图可复用部分少，逻辑层与视图层的分离不够彻底。后端对于安全考虑较少，存在隐患。部分逻辑重复，没有进行统一处理。系统整体功能仍过于简单。
通过本次研究和实践，使我对新技术有了更深入的了解和学习，同时对于页面交互和后端功能的设计与实现积累了新的经验，有了新的思路。对于暴露出的问题，将会在以后的工作和学习中注意并避免，开发更优秀的系统。

## 8. 致谢

四年的大学生活即将结束，感谢老师和同学在学习生活中对我帮助和关心，让我有足够的积累来完成最后的论文研究和编写。首先要感谢我的论文指导老师刘振宇老师，感谢老师学习中对我的指导和生活中的关心照顾，让我有了自己的目标，注重基础知识的积累与实践。也感谢老师在论文选题和实现对我指导和帮助，为我提供的各种参考资料和技巧。
感谢我学习生活中遇到的志同道合的同学，良好的学习氛围使我有共同学习和进步的动力，感谢他们对于我思路的启发和知识的拓宽，让我乐于尝试和学习新知识和技术。
最后，感谢父母对我自主自立能力的培养，让我善于独立思考和决定，使我在大学生活中能明确自己目标，并为实现目标而努力。